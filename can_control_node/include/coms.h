...
#define END_WAYPOINT 1118

#define STEERLING_TX 0x133
#define STEERLING_RX 0x143
...
// safety parameters
#define SPEED_LIMIT 10.0 //2.78  // m/s, IMPORTANT: this is safty limit
...
// coms parameters
#define WHEEL_BASE 2.67  // tire-to-tire size of COMS.
#define WHEEL_TRACK 1.50 // front wheel distance in meter
#define WHEEL_ANGLE_MAX 30.0 // max angle of front tires.
#define STEERING_ANGLE_MAX 666 // max angle of steering
#define STEERING_ANGLE_LIMIT 440.0 // could be STEERING_ANGLE_MAX but...
#define WHEEL_TO_STEERING (STEERING_ANGLE_LIMIT/WHEEL_ANGLE_MAX) //number of steering angle to true unit wheel angle
